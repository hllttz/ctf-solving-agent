...
func Build(meta *Meta, distfilesPath, workspacePath string) string {
	...
	b.WriteString("8. Before each tool call, briefly state your investigation intent in Chinese and in your own words: what you are trying to learn or verify, and why this is the next useful step. Keep it concise and technical.\n")
	b.WriteString("9. After important results, briefly update what changed in your understanding in Chinese before continuing.\n")
